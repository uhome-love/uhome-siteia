...
const properties: Property[] = [
  {
    id: "1", title: "Apartamento no Moinhos", neighborhood: "Moinhos de Vento",
    price: "R$ 1.850.000", priceLabel: "Venda", area: 142, bedrooms: 3, parking: 2,
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&h=400&fit=crop",
    badge: "Destaque",
  },
  {
    id: "2", title: "Cobertura Duplex Petrópolis", neighborhood: "Petrópolis",
    price: "R$ 2.490.000", priceLabel: "Venda", area: 228, bedrooms: 4, parking: 3,
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=400&fit=crop",
  },
  {
    id: "3", title: "Studio Moderno Bela Vista", neighborhood: "Bela Vista",
    price: "R$ 2.200/mês", priceLabel: "Aluguel", area: 38, bedrooms: 1, parking: 1,
    image: "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=600&h=400&fit=crop",
    badge: "Novo",
  },
  {
    id: "4", title: "Casa com Jardim Três Figueiras", neighborhood: "Três Figueiras",
    price: "R$ 3.200.000", priceLabel: "Venda", area: 320, bedrooms: 5, parking: 4,
    image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&h=400&fit=crop",
  },
  {
    id: "5", title: "Apto Reformado Boa Vista", neighborhood: "Boa Vista",
    price: "R$ 3.800/mês", priceLabel: "Aluguel", area: 95, bedrooms: 2, parking: 1,
    image: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=600&h=400&fit=crop",
  },
  {
    id: "6", title: "Loft Mont'Serrat", neighborhood: "Mont'Serrat",
    price: "R$ 890.000", priceLabel: "Venda", area: 68, bedrooms: 1, parking: 1,
...
function PropertyCard({ property, index }: { property: Property; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group flex-shrink-0 w-[300px] sm:w-auto"
    >
