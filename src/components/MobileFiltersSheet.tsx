        ...
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="px-5 pb-32">
              ...
              {/* Fase do imóvel */}
              <section className="mt-8">
                <p className="font-body text-base font-bold text-foreground">Fase do imóvel</p>
                <div className="mt-3 flex flex-wrap gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`rounded-full px-4 py-2.5 font-body text-sm font-medium transition-colors ${
                        filters.fase === f.value
